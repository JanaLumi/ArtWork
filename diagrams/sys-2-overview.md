...
text: `<p>The system has two journeys running in parallel, and they meet at one point. On one side, an artist entering their work. On the other, a buyer looking for artwork to live with. The data layer is where they find each other.</p>
