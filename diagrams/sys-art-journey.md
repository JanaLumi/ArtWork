...
text: `<p>You are an artist and you have some photos of your work to add to the catalogue. Maybe a whole body of work ready to go at once, maybe just one piece you want to place carefully. You choose how to enter — a batch of images with a spreadsheet, or a single piece on its own. Either way, nothing leaves your machine.</p>
